...
/*   Updated: 2023/11/07 13:02:09 by alsaez           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Bureaucrat " << getName() << ", with grade "
		<< getGrade() << ", was created" << std::endl;
}
...
{
	std::cout << "A new copy of Bureaucrat " << getName()
		<< ", with grade " << getGrade() << ", was made" << std::endl;
}
...
void Bureaucrat::signForm(AForm &f)
{
	if (f.getSigned())
	{
		std::cout << "Form " << f.getName() << " has been signed already." <<  std::endl;
		return ;
	}
	try
	{
